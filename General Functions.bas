...
Public Const ATTR_READONLY = 1    'Read-Only file
Public Const ATTR_VOLUME = 8      'Volume label
Public Const ATTR_ARCHIVE = 32    'File has changed since last back-up
Public Const ATTR_NORMAL = 0      'Normal files
Public Const ATTR_HIDDEN = 2      'Hidden files
Public Const ATTR_SYSTEM = 4      'System files
Public Const ATTR_DIRECTORY = 16  'Directory

Public Const ATTR_DIR_ALL = ATTR_DIRECTORY + ATTR_READONLY + ATTR_ARCHIVE + ATTR_HIDDEN + ATTR_SYSTEM
Public Const ATTR_ALL_FILES = ATTR_NORMAL Or ATTR_HIDDEN Or ATTR_SYSTEM Or ATTR_READONLY Or ATTR_ARCHIVE

Public Function ExtractFileName(ByVal FilePath As String) As String

' Extract the File name from a full file path
' This function is VB6-specific
...
Function ExtractFileNameOld(Filename As String) As String
    
' Extract the File name from a full file name
' older version, does not use the VB6-specific InstrRev() function
    ...
    ExtractFileNameOld = Right(Filename, Len(Filename) - PrevPos)
